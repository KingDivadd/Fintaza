                ...
                <div className="mt-10 w-full flex flex-col items-start justify-start shadow-lg rounded-[3px] border border-slate-200">
                            ...
                            <div className="w-full min-w-[1024px] h-[500px] flex flex-col items-start justify-start overflow-y-auto">
                                <div className="w-full h-full flex flex-col justify-start">
                                    {[1, 2, 4, 5, 1, 1, 1, 1, 1, 1].map((data, ind) => {
                                        return (
                                            <span key={ind} className="table-body-row-1 flex">
                                                ...
                                                {ind == 1 ? (
                                                    <p className="text-sm font-[500] w-[15%] px-[15px] text-amber-600">Pending</p>
                                                ) : (
                                                    <p className="text-sm font-[500] w-[15%] px-[15px] text-teal-700">Approved</p>
                                                )}

                                                {ind == 1 ? (
                                                    <span className="text-sm font-[500] w-[20%] px-[15px] flex justify-start gap-5 items-center">
                                                        <button className="h-[27.5px] text-sm px-5 rounded-[2px] text-white bg-teal-700 hover:bg-teal-800">
                                                            accept
                                                        </button>
                                                        <button className="h-[27.5px] text-sm px-5 rounded-[2px] text-white bg-red-600 hover:bg-red-700">
                                                            reject
                                                        </button>
                                                    </span>
                                                ) : (
                                                    <span className="text-sm font-[500] w-[20%] px-[15px] flex justify-start">
                                                        <button className="h-[27.5px] text-sm px-5 rounded-[2px] bg-blue-600 hover:bg-blue-700 text-white">
                                                            view
                                                        </button>
                                                    </span>
                                                )}
                    ...
                    <span className="w-full h-[50px] flex flex-row items-center justify-between bg-white rounded-b-[3px] border-t border-gray-300 px-[15px]">
                        <span className="flex flex-row items-center justify-start gap-3 h-full">
                            ...
                            <span className="w-auto h-full flex flex-row items-center justify-start">{render_page_numbers()}</span>
